...
class MazeApp:
    def __init__(self, maze_files):
        ...
        self.solution_path = []  # Store the solution path for animation
    ...
    def create_gui(self):
        ...
        self.solve_stack_button = ttk.Button(self.control_frame, text="Solve with Stack", image=solve_img, compound="left", 
        ...
        self.solve_queue_button = ttk.Button(self.control_frame, text="Solve with Queue", image=solve_img, compound="left", 
